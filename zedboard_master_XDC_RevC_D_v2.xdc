...
# VGA Output - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y21  [get_ports {b_out[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {b_out[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {b_out[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {b_out[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {g_out[0]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {g_out[1]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {g_out[2]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {g_out[3]}];  # "VGA-G4"
set_property PACKAGE_PIN V20  [get_ports {r_out[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {r_out[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {r_out[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {r_out[3]}];  # "VGA-R4"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {sel}];  # "SW0"
